...
public class StandardIncomeStatment {


private List<FinancialIncomeStatmentDTO> data = null;
...
public List<FinancialIncomeStatmentDTO> getData() {
return data;
}

public void setData(List<FinancialIncomeStatmentDTO> data) {
this.data = data;
}
