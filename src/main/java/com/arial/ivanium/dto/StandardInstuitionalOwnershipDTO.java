...
public class StandardInstuitionalOwnershipDTO {


private List<IntiutionalOwnershipDTO> data = null;
...
public List<IntiutionalOwnershipDTO> getData() {
	return data;
}

public void setData(List<IntiutionalOwnershipDTO> data) {
	this.data = data;
}
